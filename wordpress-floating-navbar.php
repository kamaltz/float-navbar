...
class TirtonicAdvancedFloatingNavbar {
    ...
    private function get_default_menu_items() {
        return array(
            array('title' => 'Home', 'url' => home_url(), 'icon' => 'home'),
            array('title' => 'Shop', 'url' => 'https://tirtonic.com/store', 'icon' => 'shop'),
            array('title' => 'Articles', 'url' => 'https://tirtonic.com/article', 'icon' => 'article'),
            array('title' => 'About', 'url' => 'https://tirtonic.com/stores', 'icon' => 'about'),
            array('title' => 'Contact', 'url' => 'https://tirtonic.com/contact', 'icon' => 'contact')
        );
    }
    ...
    private function get_icon_library() {
        return array(
            ...
            'article' => '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg>',
            ...
            'link' => '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H6.9C4.29 7 2.2 9.09 2.2 11.7s2.09 4.7 4.7 4.7H11v-1.9H6.9c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm5-6h4.1c2.61 0 4.7 2.09 4.7 4.7s-2.09 4.7-4.7 4.7H13v1.9h4.1c2.61 0 4.7-2.09 4.7-4.7S19.71 7 17.1 7H13v1.9z"/></svg>'
        );
    }
    ...
    public function render_navbar() {
        ...
        ?>
        <div id="tirtonicFloatingNav" class="tirtonic-floating-nav <?php echo esc_attr($position_class); ?>" data-settings='<?php echo esc_attr(json_encode($this->options)); ?>' data-mobile-scale="<?php echo esc_attr($this->options['mobile_scale'] ?? 80); ?>" data-mobile-breakpoint="<?php echo esc_attr($this->options['mobile_breakpoint'] ?? 768); ?>">
            <div class="tirtonic-nav-header">
                <div class="tirtonic-nav-toggle">
                    <span class="tirtonic-nav-title"><?php echo esc_html($title); ?></span>
                    <span class="tirtonic-nav-arrow">
    ...
    private function render_custom_styles() {
        ...
        @media only screen and (max-width: 768px) {
            .tirtonic-floating-nav {
                ...
                top: auto !important;
                transform: translateX(-50%) scale(<?php echo ($this->options['mobile_scale'] ?? 80) / 100; ?>) !important;
                transform-origin: bottom center !important;
                width: calc(100% - 40px) !important;
                max-width: 350px !important;
                z-index: var(--tirtonic-z-index) !important;
            }
            ...
            .tirtonic-nav-title {
                font-size: calc(var(--tirtonic-title-size) * 1.1) !important;
            ...
            .tirtonic-nav-cart svg,
            .tirtonic-nav-custom-icon svg {
                width: calc(var(--tirtonic-icon-size) * 1.2) !important;
                height: calc(var(--tirtonic-icon-size) * 1.2) !important;
            }
            
            .tirtonic-nav-arrow svg {
                width: calc(var(--tirtonic-icon-size) * 0.8) !important;
                height: calc(var(--tirtonic-icon-size) * 0.8) !important;
            }
            
            .quick--access-content_link1 a {
                font-size: calc(var(--tirtonic-menu-size) * 1.3) !important;
                padding: 15px 20px !important;
            ...
            .quick--access-content_link2 a {
                font-size: calc(var(--tirtonic-submenu-size) * 1.2) !important;
